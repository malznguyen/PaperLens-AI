    ...
    <div className="rounded-[1.6rem] border border-[color:var(--line)] bg-white/82 p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-2 text-[1.45rem] text-slate-900">Latency and evidence counts</h3>
        </div>
...
function MetricTile({ icon: Icon, label, value }: MetricTileProps) {
  return (
    <div className="rounded-2xl border border-[color:var(--line)] bg-[#f6f0e7] px-4 py-4">
      <div className="flex items-center gap-3">
        <div className="rounded-2xl border border-[color:var(--line)] bg-white/82 p-2 text-[color:var(--accent)]">
